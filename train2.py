...
def main(args):
    ...
    Teacher_model.load_state_dict(torch.load(args.weights, map_location=device))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-path', type=str,
                        default="./data/增强train")
    parser.add_argument('--valid-path', type=str,
                        default="./data/valid")

    # 预训练权重路径，如果不想载入就设置为空字符
    parser.add_argument('--weights', type=str, default='./weights0/model-59.pth',
